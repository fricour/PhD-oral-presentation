...
plot_ly(DIC_data, x = ~mean_DIC, y = ~mids, type = 'scatter', mode = 'lines', color = I('#001852')) |>
   layout(xaxis = list(title = 'DIC (&mu;mol kg<sup>-1</sup>)', tickfont = list(size = 20), titlefont = list(size = 20)), yaxis = list(title = list(text = 'Depth (m)', standoff = 15L), autorange="reversed", tickfont = list(size = 20), titlefont = list(size = 20)),
...
# UVP6 embedded classification {background-color="white"}
...
# UVP6 and OST in the Labrador Sea {background-color="white"}
...
<span style="font-size: 30px;">Float 6904240 --- 21<sup>st</sup> cycle @1000 m<br><br>F<sub>small</sub> = 633 x (ATN<sub>slope</sub>)<sup>0.77</sup> <span style="color: gray;"><br>(Estapa et al., 2023)</span> <br><br> F<sub>large</sub> = 633 x (Jump<sub>total</sub>/drifting time)<sup>0.77</sup></span>
:::
...
&#x25B2; Deployment sites<br>
{{< fa regular circle size=tiny >}} Last profile<br><br><br>Last updated on `r format(Sys.time(), '%d %B, %Y', tz = 'UTC')`
:::
...
# Perspectives {background-color="white"}
...
## Application of the UVP embedded classification
