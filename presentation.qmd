...
<span style="font-size: 30px;">OCIM model <span style="color: gray;">(Devries et al., 2017)</span><br><br>
...
## 7 CONVERSE versions to compute F<sub>remin</sub>
...
df <- data.frame(version = c('C1', 'C2', 'C3', 'C4', 'C5', 'C6', 'C7'),
            b_factor = c(0.86, 'Variable', 'Regional', '', '', 0.86, 0.86),
            export_depth = c(100, 100, 100, 'Zeu', 100, 100, 100),
            export_value = c(3,3,3,8.6,7.3,3,3))
...
```
<span style="font-size: 30px;">F<sub>remin</sub> = f(pixel, depth layer, C#)<br></span>
