...
<ins>Sensor development</ins> <span style="color: gray;">&#10230; Sensor application &#10230; Model</span> 
...
<span style="color: gray;">Sensor development &#10230; </span><ins>Sensor application</ins><span style="color: gray;"> &#10230; Model</span> 
:::
...
{{< fa book >}} Reassessment of <span style="color: white;background-color:#001852;border-radius: 10px">global sequestration fluxes</span> by the <span style="color: white;background-color:#001852;border-radius: 10px">BCP</span><br><span style="color: black;background-color:white;border-radius: 10px">A continuous approach to carbon storage ($\geq$ 100 years)</span><br><br>
 <span style="color: gray;">Sensor development &#10230; Sensor application &#10230; </span><ins>Model</ins> 
:::
...
::: {.fragment .fade-in}
![](intro/model.svg){.absolute top="40%" left="40%" width="600"}
:::
...
-   [Exploratory]{style="color: white;background-color: #001852;border-radius: 10px"} work (1 year of data)
    -   First OST-UVP comparison
...
![](converse/Fig5PREZ.svg){.absolute top=80 left=-60 width="800" height="600"}
...
<span style="font-size: 30px;color: white;background-color: #001852;border-radius: 10px;">Mixing --- 11-23% of F<sub>seq</sub>(BCP)<br></span>
<span style="font-size: 30px;color: white;background-color: #001852;border-radius: 10px;">Migrant --- 9-12% of F<sub>seq</sub>(BCP)</span>
:::
...
## Improvement points {.smaller}

[Sensor]{style="color: white;background-color: #001852;border-radius: 10px"} scale<br>

-   20/40 classes in the model
-   New features (e.g. texture)
-   Deal differently with detritus
    
[Float]{style="color: white;background-color: #001852;border-radius: 10px"} scale<br>
...
[Global]{style="color: white;background-color: #001852;border-radius: 10px"} scale<br>
-   Wait to validate/calibrate with in-situ data (float)
