...
# And so it begins (1/5) {background-color="white"}
...
::: small-text
Fewer resources and efficient [(Chen et al., 2016)]{style="color: gray;"}
:::
:::
:::
:::
...
CNN has (clearly) a higher recall<br><br> CNN (if) not energy limited<br><br> CNN has its own features<br><br>
