...
::: columns
::: {.column width="60%"}
<br>Fossil fuel emissions --- 35 Gt CO<sub>2</sub> year<sup>-1</sup></sub><br>
50% stays in the atmosphere<br><br>
25% absorbed by land<br><br>
[25%]{style="color: white;background-color: #001852;border-radius: 10px"} absorbed by <span style="color: white;background-color:#001852;border-radius: 10px">oceans</span><br>
DIC = HCO<sub>3</sub><sup>-</sup> + CO<sub>3</sub><sup>2-</sup> + H<sub>2</sub>CO<sub>3</sub> + CO<sub>2</sub> (aq)
:::
...
<span style="color: white;background-color:#001852;border-radius: 10px">How much</span> carbon is exported/injected by each pump?<br><br>
<span style="color: white;background-color:#001852;border-radius: 10px">How deep</span> is it exported/injected?<br><br>
<span style="color: white;background-color:#001852;border-radius: 10px;opacity:0.25">How long</span><span style="opacity:0.25;"> CO<sub>2</sub> is sequestered from the atmosphere?</span><br><br><br>
<span style="color:white;background-color:#001852;border-radius: 10px">Sensor development</span><span style="color: black;opacity:0.25"> &#10230; Sensor application &#10230; Global model</span>
:::
:::
...
::: footer
Left figures from Picheral et al. (2021)
:::
...
<span style="color: white;background-color:#001852;border-radius: 10px">How much</span> carbon is exported/injected by each pump?<br><br>
<span style="color: white;background-color:#001852;border-radius: 10px">How deep</span> is it exported/injected?<br><br>
<span style="opacity:0.25;"><span style="color: white;background-color:#001852;border-radius: 10px;">How long</span> CO<sub>2</sub> is sequestered from the atmosphere?</span><br><br><br>
<span style="color: black;opacity:0.25;">Sensor development &#10230; </span><span style="color:white;background-color:#001852;border-radius: 10px">Sensor application</span><span style="color: black;opacity:0.25;"> &#10230; Global model</span> 
:::
...
::: {style="position:absolute;top:15%;"}
<span style="opacity:0.25;"><span style="color: white;background-color:#001852;border-radius: 10px">How much</span> carbon is exported/injected by each pump?</span><br><br>
<span style="opacity:0.25;"><span style="color: white;background-color:#001852;border-radius: 10px">How deep</span> is it exported/injected?</span><br><br>
<span style="opacity:1;"><span style="color: white;background-color:#001852;border-radius: 10px;">How long</span> CO<sub>2</sub> is sequestered from the atmosphere?</span><br><br><br>
<span style="color: black;opacity:0.25">Sensor development &#10230; Sensor application &#10230; </span><span style="color:white;background-color:#001852;border-radius: 10px">Global model</span>
:::
...
<span style="color: white;background-color:#001852;border-radius: 10px">How much</span> carbon is exported/injected by each pump?<br><br>
<span style="color: white;background-color:#001852;border-radius: 10px">How deep</span> is it exported/injected?<br><br>
<span style="color: white;background-color:#001852;border-radius: 10px">How long</span> CO<sub>2</sub> is sequestered from the atmosphere?<br><br><br>
<span style="color: black;">Sensor development &#10230; </span>Sensor application<span style="color: black;"> &#10230; Global model</span> 
:::
...
image_folder <- './images/uvp6_images/alive_inverted/'
...
::: {style="position:absolute;top:25%;left:50%;"}
<br>16 biological labels<br> 
4 non-living labels<br><br>
...
float_6904240 <- vroom('DATA/ARGO/6904240_FromNetCDF.csv')
float_6904241 <- vroom('DATA/ARGO/6904241_FromNetCDF.csv')
float_4903634 <- vroom('DATA/ARGO/4903634_FromNetCDF.csv')
float_1902578 <- vroom('DATA/ARGO/1902578_FromNetCDF.csv')
...
F<sub>small</sub> $\propto$ weighted average <span style="background-color:#DCEEF3;border-radius: 10px;">c<sub>p</sub> slope</span>
...
▲ Deployment sites<br> {{< fa regular circle size=tiny >}} Last profile<br><br><br>Last updated on [May 22, 2023]{style="color: white;background-color:#001852;border-radius: 10px"}
:::
...
mld_data <- vroom('DATA/ARGO/npq_corrected_data.csv')
...
## [Reminder]{style="color: white;background-color:#001852;border-radius: 10px"} --- From data to model to data to model to data to model to ...
...
float_1902593 <- vroom('DATA/ARGO/1902593_FromNetCDF.csv')
float_2903783 <- vroom('DATA/ARGO/2903783_FromNetCDF.csv')
float_4903657 <- vroom('DATA/ARGO/4903657_FromNetCDF.csv')
...
::: footer
<span style="color:black;">@Col d'Èze {{< fa person-biking >}}</span>
:::
...
<strong>Supervisors</strong> --- Hervé - Lionel - Alexander<br>
